...
const ChartComponent = () => {
  ...
  const handleDrawingInfosend = async (event) => {
    ...
    if (whether_drawing === false){ // 이전에 데이터가 없고, 새로 넣을때
      try {
        const response = await axios.post("http://13.125.16.222:8080/v1/careers", {
            arr : chartData,
        }, 
        {
            headers: {
      ...
      try {
        const response = await axios.patch("http://13.125.16.222:8080/v1/careers", {
            arr : chartData,
        }, 
        {
            headers: {
    ...
    <div className="chart_body">
      ...
      <div className="chart_header">
        <div className="chart_header_c1">
          <Link to="/"><img className="chart_header_c1_logo" src={require("../image/logo.png")} alt="Logo" /></Link>
        </div>
              ...
              <div className="chart_question_container_c2_container">
                ...
                <form onSubmit={handleDrawingInfosend}>
                  <button className='save'>
                    <img className="save_logo" src={require("../image/logo.png")} alt="Logo"/>
